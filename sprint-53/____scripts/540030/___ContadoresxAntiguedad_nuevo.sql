...
SET @p_params= '<NodoXML><LI><valor></valor><zonaD>Z030</zonaD><zonaH>Z030</zonaH></LI></NodoXML>';
/*
...
*/
	...
	SELECT R.Zona, R2.Contrato, R.Uso, R.[Dirección Suministro], R.Contador, R.Diametro, R.[F.Instalación], R.Marca, R.Emplazamiento, R.Edad, R.Ruta1, R.Ruta2, R.Ruta3, R.Ruta4, R.Ruta5, R.Ruta6 
	FROM #RESULT2 AS R2
	LEFT JOIN #RESULT AS R
	ON R.Contrato = R2.Contrato
	--WHERE R2.contrato = 273736
	ORDER BY R2.Contrato


	SELECT * FROM #RESULT2 AS R 
	--WHERE contrato = 273736
	ORDER BY Contrato
