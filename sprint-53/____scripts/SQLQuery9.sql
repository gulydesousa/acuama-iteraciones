CREATE TABLE otInspeccionesValidaciones2 (
    otivColumna VARCHAR(128),
    otivServicioCod TINYINT,
    otivCritica BIT CONSTRAINT DF_otivCritica2 DEFAULT 1 NOT NULL, 
    otivReqReglamentoCTE BIT CONSTRAINT DF_otivReqReglamentoCTE2 DEFAULT 1 NOT NULL, 
    otivOrden TINYINT NOT NULL,
    otivClave VARCHAR(250) NOT NULL,
    otivDescParaCartas VARCHAR(250),
    otivInformativo BIT CONSTRAINT DF_otInspeccionesValidaciones_otivInformativo2 DEFAULT 0 NOT NULL,
    otivValorDefecto VARCHAR(250) ,    
    CONSTRAINT PK_otInspeccionesValidaciones2 PRIMARY KEY (otivColumna, otivServicioCod),
	CONSTRAINT FK_otInspeccionesValidaciones_otInspeccionesServicios2
	FOREIGN  KEY (otivServicioCod)
	REFERENCES otInspeccionesServicios(otisCod));
GO


INSERT INTO otInspeccionesValidaciones2
VALUES
