...
AS
	...
	BEGIN TRY
		...
		VALUES (
			...
			EXEC dbo.otInspecciones_Melilla_DatosValorApto @objectid, @xmldata = @xmlApto OUTPUT;
			...
			DECLARE @OTAPTO AS VARCHAR(25) = 'NO';
			SELECT @OTAPTO = Apto FROM @DATOSVALOR WHERE objectId= @objectid;
