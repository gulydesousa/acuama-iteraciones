...
exec otInspeccionesValidaciones_Select @columna='calibre'
...
SET @columna = UPPER(CONCAT('%', LTRIM(RTRIM(@columna)), '%'));
...
AND (@columna IS NULL OR @columna='' OR UPPER(I.otivColumna) LIKE @columna)
