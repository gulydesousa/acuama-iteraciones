...
/*
  ...
  EXEC [InformesExcel].[Contador_SelectInstalados] @incidenciaCambioContador, @codigo, @inciLecLectorD, @inciLecLectorH, @inciLecInspD, @inciLecInspH, @contratoD, @contratoH, @contadorD, @contadorH, @fechaCompraD
...
CREATE PROCEDURE [InformesExcel].[Contador_SelectInstalados] 
	@incidenciaCambioContador BIT = NULL, --True = Obtiene también los que tengan la marca "cambio de contador" en la incidencia de lectura. False ó NULL obtiene todos
	@codigo INT = NULL,
	@inciLecLectorD VARCHAR(2) = NULL,
	@inciLecLectorH VARCHAR(2) = NULL,
