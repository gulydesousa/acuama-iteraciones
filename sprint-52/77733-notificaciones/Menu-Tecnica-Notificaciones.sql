...
BEGIN
	INSERT INTO menu VALUES(@menuID, @notificaciones, 'Emisión de notific.', NULL, NULL, @urlNotif, '~/Catastro/Css/emisionNotificaciones.css',  NULL, NULL, 10, 1, 1)
	SET @menuID = @menuID+1; 
END
...
BEGIN
	INSERT INTO menu VALUES(@menuID, @notificaciones, 'Informes Excel', NULL, NULL, @urlExcel, '~/Sistema/Css/visorInformesExcelPerfil.css',  NULL, NULL, 20, 1, 1)
	SET @menuID = @menuID+1; 
END
