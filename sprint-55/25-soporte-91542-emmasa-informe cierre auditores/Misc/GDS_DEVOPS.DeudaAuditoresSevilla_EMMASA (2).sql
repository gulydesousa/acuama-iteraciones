...
*/
	...
	--*** DEBUG ***
	--SELECT * FROM #ENTREGAPORNIF WHERE NIF = '43804682D'
	...
	--*** DEBUG ***
	--SELECT * FROM #ENTREGASCUENTA WHERE NIF = '43804682D'
	...
	--*** DEBUG ***
	--SELECT * FROM #FACS WHERE facCtrCod= 110139360 AND facNumero IN ('2112002211', '1512007008')
	...
	, ROW_NUMBER() OVER (PARTITION BY F.facCod , F.facPerCod, F.facCtrCod ORDER BY CB.cobFec DESC, CB.cobFecReg DESC) AS RN
	FROM  #FACS AS F
