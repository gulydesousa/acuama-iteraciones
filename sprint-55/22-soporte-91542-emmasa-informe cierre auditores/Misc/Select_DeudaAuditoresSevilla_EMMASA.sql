...
SET @p_params= '<NodoXML><LI><FecDesde>20140101</FecDesde><FecHasta>20240613</FecHasta></LI></NodoXML>';
...
AS
	...
	SELECT * INTO #FACS 
	FROM FACS WHERE facCtrCod='110139360';
	...
	--AND CBL.cblFacVersion = F.facVersion //SYR-544078: Deuda para las facturas rectificadas
