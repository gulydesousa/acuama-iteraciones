...
BEGIN TRY
	...
	, FL_RN = ROW_NUMBER() OVER(PARTITION BY F.facPercod, F.facCod, F.facVersion ORDER BY FL.fclNumLinea) 
	, NumOriginalesxCtr = 0
	...
	, A.ctrUso = C.ctrUso
	, NumOriginalesxCtr = I.NumOriginalesxCtr
	, NumRectificativasConCanon = I.NumRectificativasConCanon
	FROM #AUX AS A 
	LEFT JOIN F
