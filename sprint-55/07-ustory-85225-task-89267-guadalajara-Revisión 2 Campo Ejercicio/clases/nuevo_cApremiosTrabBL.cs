...
namespace BL.Cobros
{
    ...
    public static class cApremiosTrabBL
    {
        ...
        internal static cLineaFacturaBO lineaAjustada(cBindableList<cLineaFacturaBO> lineasFactura, decimal totalFactura, out decimal impAjuste)
        {
        ...
        internal static string LogApremiosCSV(StringBuilder logAjustes, int numApremio, string rutaDoc)
        {
        ...
        internal static string añoValor(cFacturaBO factura)
        {
        ...
        internal static string numeroValor(cFacturaBO factura)
        {
        ...
        internal static string periodoValor(cFacturaBO factura)
        {
        ...
        {
            #region ✩85225-sprint52-apremios-guadalajara
            if (!string.IsNullOrEmpty(ClassVersion))
            {
                ...
                cApremiosTrab_GuadalajaraBL apremiosGuadalaraja = 
                new cApremiosTrab_GuadalajaraBL(ClassVersion
                                              , usuarioCodigo
                                              , numeroApremioGenerado
                ...
                return apremiosGuadalaraja.procesar(out respuesta, out numeroApremioGenerado, out log, out apremiosProcesados);              
            }
            #endregion ✩85225-sprint52-apremios-guadalajara
        ...
        private static int _diasPagoVoluntario;
        
        private static string _cApremiosTrabBL;


        static cApremiosTrabBL()
        {
            cRespuesta respuesta;
            respuesta = cParametroBL.GetInteger("DIAS_PAGO_VOLUNTARIO", out _diasPagoVoluntario);

            //Si algo falla, seteamos a 60 por defecto
            if (respuesta.EsResultadoErroneo) _diasPagoVoluntario = 60;

            //Si algo falla, seteamos string.Empty por defecto
            respuesta = cParametroBL.GetString("cApremiosTrabBL", out _cApremiosTrabBL);
        }

        /// <summary>
        /// Dias que se establecen como límite para el pago voluntario.
        /// Se inicializa con la clase  con el valor del parametro DIAS_PAGO_VOLUNTARIO
        /// </summary>
        public static int DiasPagoVoluntario
        {
            get
            {
                return _diasPagoVoluntario;
            }
        }

        /// <summary>
        /// Se guarda en la tabla parametros la version de la clase que queremos utilizar
        /// </summary>
        public static string ClassVersion
        {
            get
            {
                return _cApremiosTrabBL;
            }
        }
        #endregion ✩85225-sprint52-apremios-guadalajara
    }
