...
AS
	...
	, emisionEstado = CASE	WHEN I.MOCK=1
							THEN 'Inspección ficticia' -- Se ha creado para incluir la inspección general entre los abonados
							--El cliente (o el titular) ya están notificados (en papel 1, 8)
