...
VALUES('000/012'
, 'Padrón Excel por Bloques'
, 'Padrón Excel por Bloques—unidades y precios—'
, 	12
, '[InformesExcel].[PadronxBloques_CSV]'
, 'CSVH'
, 'Padrón detallado por bloques—unidades y precios—.<p><i>INCLUYE prefacturas y EXCLUYE rectificadas.</i> <b>Formato CSV</b></p>'
, NULL
, NULL
, NULL
, NULL)
...
AS
	...
	, facLecAnt, facLecAntFec
	, facLecAct, facLecActFec
