...
AND T.trfFecReg = '20240729' --Tarifas del excel del syrena dadas de alta
...
ON T.trfsrvcod = TV.trvsrvcod
AND T.trfcod = TV.trvtrfcod
AND T.trfFecUltMod = '20240729' --Tarifas que hay que se han dado de baja
...
WHERE CS.ctsfecbaj='20240801' AND CS.ctsfecrealbaja='20240729' 
